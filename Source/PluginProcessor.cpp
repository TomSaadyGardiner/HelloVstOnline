...
//==============================================================================
const juce::String HelloVSTAudioProcessor::getName() const
{
...
bool HelloVSTAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
const juce::String HelloVSTAudioProcessor::getProgramName (int index)
{
    return {};
}

void HelloVSTAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void HelloVSTAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* HelloVSTAudioProcessor::createEditor()
{
...
//==============================================================================
void HelloVSTAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
// my code!
juce::AudioProcessorValueTreeState::ParameterLayout HelloVSTAudioProcessor::createParameterLayout()
{
    ...
    juce::StringArray stringArray; // creates string array and generates names for filter slopes (12,24,36,48)
    for (int i = 0; i < 4; ++i)
    {
        juce::String str;
        str << (12 + i*12);
